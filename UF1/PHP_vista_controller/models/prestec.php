...
function __construct(/*$codi,$isbn,$dni,$data_prestec,$data_retorn,$retornat*/){
   /* $this->$codi;
    $this->$isbn;
    $this->$dni;
    $this->$data_prestec;
   ...
   public function insertar(){
      $con=database::conectar();
         $afegir="INSERT INTO `prestec`( `ISBN`, `DNI`,`data_retorn`, `retornat`) VALUES ('{$this->getIsbn()}','{$this->getDni()}','{$this->getData_retorn()}','{$this->getRetornat()}')";
         $con->query($afegir);
